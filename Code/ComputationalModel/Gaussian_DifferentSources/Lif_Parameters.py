...
max_conn_int_l0 = max_conn_scale_free(a, lower_degree_limit, upper_degree_limit, n_cells, number_degree_values, val)
max_conn_int = int(n_cells*perc_conn_int/100) + np.random.randint(-10, 10, size=n_cells)
...
#   3D connectivity
###########################################
type_connectivity = 'central'      # random/central/multiple_centres
###########################################
