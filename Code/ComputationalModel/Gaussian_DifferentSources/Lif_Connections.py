...
# def conneting_population_l0(pop: NeuronGroup, exc: NeuronGroup, inh: NeuronGroup, p_max: float):
#     """
...
#             if ss.N_outgoing_pre[idx] > max_conn_int_l0[idx]:
#                 diff = ss.N_outgoing_pre[idx] - max_conn_int_l0[idx]  # connessioni da eliminare
#                 k = count - diff
#                 r = []
...
#                     ss.w[r[index1] + k - max_conn_int_l0[idx]] = 0
#     return s_exc_all, s_inh_exc
...
def conneting_layers(pop_source: NeuronGroup, exc_source: NeuronGroup, inh_source: NeuronGroup, 
    ...
    """
      ...
      :param p_max: maximum probability of connection between 2 neurons
      :return: s_exc_all, s_inh_exc
      """
...
if __name__ == '__main__':
    ...
    plot(l0_exc.x[neuron_idx_exc] / umeter, l0_exc.y[neuron_idx_exc] / umeter, 'og', markersize=8)
    ...
    plot(l0_inh.x[neuron_idx_inh] / umeter, l0_inh.y[neuron_idx_inh] / umeter, 'og', markersize=8)
    ...
    figure(3)
    scatter(l0_exc.x[s_exc_all_l0l1.i] / umeter, l0_exc.y[s_exc_all_l0l1.i] / umeter, marker='.', c='r')
    scatter(l0_inh.x[s_inh_exc_l0l1.i] / umeter, l0_inh.y[s_inh_exc_l0l1.i] / umeter, marker='.', c='b')
    xlabel('x (µm)')
    ylabel('y (µm)', rotation='vertical')
    axis('equal')
    tight_layout()
