...
DateFolder = '2022-05-02'   # Date in the format aaaa-mm-dd
SimulationNumber = 5        # Number of simulation in the date
...
comment = '\nNumber of layers:\t' + str(num_layers) + \
          ...
          '\nimplementation of scale free connectivity in L0 (threshold in other layers: ' \
          '\n\t - slope: ' + str(a) + \
